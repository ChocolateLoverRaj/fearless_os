...
pub const PAGE_TABLE_512G: u16 = PAGE_TABLE_256T + 0x1000;
pub const PAGE_TABLE_1G: u16 = PAGE_TABLE_512G + 0x1000;
pub const SECTOR_1: u16 = PAGE_TABLE_1G + 0x1000;
...
pub const DYNAMIC_VIRT_ADDR: u64 = 0xFFFF_8000_4000_0000;
pub const DYNAMIC_VIRT_LEN: u64 = 0x3FFFC0000000;
